...
import { Copy, Download, ThumbsUp, ThumbsDown, X, Wand2, Loader2, Bot, Menu, MessageSquare, Save } from "lucide-react"
    ...
    <div className="flex-1 flex flex-col h-full bg-white/90 backdrop-blur-sm shadow-lg max-w-full">
      ...
      <div className="flex justify-between items-center p-2 sm:p-4 border-b border-gray-200 bg-white/80 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-1 sm:gap-4">
          ...
          <Button variant="ghost" size="icon" onClick={onToggleDetails} className="md:hidden" title="Toggle details">
            <Menu size={18} />
          </Button>
          <Button
            variant="ghost"
      ...
      <div className="flex-1 overflow-y-auto p-2 sm:p-4 space-y-4 sm:space-y-6 bg-white/50">
        {conversation.map((message) => (
          <div key={message.id} className="space-y-1 animate-fadeIn rounded-lg p-2 sm:p-3 hover:bg-gray-50/50">
            <div className="flex items-center gap-2">
              <div
            ...
            {message.sender === "agent" && (
              <div className="flex gap-2 mt-2 ml-10">
                ...
                >
                  <ThumbsUp
                    size={16}
                    className={message.reactions.likes > 0 ? "text-blue-600 fill-blue-600" : ""}
                  />
                </Button>
                <Button
                  variant="ghost"
                ...
                >
                  <ThumbsDown
                    size={16}
                    className={message.reactions.dislikes > 0 ? "text-red-600 fill-red-600" : ""}
                  />
                </Button>
              </div>
            )}
        ...
        {isTyping && (
          <div className="space-y-1 animate-fadeIn">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-blue-600">PromptHUB agent</span>
