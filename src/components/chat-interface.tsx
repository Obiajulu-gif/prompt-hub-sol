  ...
  const handleSendMessage = async (content: string) => {
    ...
    try {
      ...
      const fallbackMessage: Message = {
        id: Date.now().toString(),
        sender: "agent",
        content: "I apologize, but I'm having trouble connecting to our services. Could you please try again?",
        timestamp: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }),
        reactions: { likes: 0, dislikes: 0 },
      }
      ...
      prev.map((message) =>
        message.id === messageId
          ? {
              ...
              reactions: {
                ...message.reactions,
                likes: type === "like" ? message.reactions.likes + 1 : message.reactions.likes,
                dislikes: type === "dislike" ? message.reactions.dislikes + 1 : message.reactions.dislikes,
              },
            }
          : message,
      ),
